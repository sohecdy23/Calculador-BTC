                ...
                <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="index.php"> Compra bitcoins</a></li>
                            <li class="active"><a href=""> Venta bitcoins</a></li>
                        </ul>
                    </div>
...
<?php
     switch (strtolower($_GET['metodo'])) {
         case 'paypal':
               $metodo = $_GET['metodo'];
               $url = "https://localbitcoins.com/sell-bitcoins-online/usd/paypal/.json";
               ...
               while($contador < $Limite_Ofertas && $contador < $Cantidad_Ofertas){
                ...
                echo"<h3><strong> Calculos Btc  </strong></h3>";
                    ...
                    $urlsell = "https://localbitcoins.com/buy-bitcoins-online/VE/venezuela/.json";
       ...
       case 'payoneer':
             $metodo = $_GET['metodo'];
             $url = "https://localbitcoins.com/sell-bitcoins-online/usd/payoneer/.json";
             $json = file_get_contents($url);
             $array = json_decode($json, true);
             $contador = 0;
             $Limite_Ofertas = 4;
       ...
       case 'neteller':
             $metodo = $_GET['metodo'];
             $url = "https://localbitcoins.com/sell-bitcoins-online/usd/neteller/.json";
             $json = file_get_contents($url);
             $array = json_decode($json, true);
             $contador = 0;
             $Limite_Ofertas = 4;
